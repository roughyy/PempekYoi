<footer class="footer bg-[#ECFAF7] pt-[80px] lg:pt-[0px] pb-[80px] lg:pb-[0px] font-light bg-no-repeat">
    <div class="container">
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                <a href="index.html" class="block mb-[25px]">
                    <img src="assets/images/logo/logo.png" width="300" loading=lazy alt="footer logo">
                </a>
                <p style="padding-left: 75px;"> &copy; All rights reserved </p>
            </div>
            <div class=" col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                <h3 class="font-recoleta font-normal text-[22px] leading-[1.222] text-primary123 mb-[20px] lg:mb-[30px]">Location<span class="text-secondary"></span></h3>
                <p>BSD, Tangerang Selatan</p>
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    <li class="mr-[10px]"><a target="_blank" href="https://www.instagram.com/pempekyoi" class=" w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="mr-[10px]"><a target="_blank" href="https://www.tokopedia.com/pempek-yoi">
                            <img src="assets/images/logo_tokopedia.png" height="26" width="26">
                        </a></li>
                    <li><a target="_blank" href="https://wa.wizard.id/784f80">
                            <img src="assets/images/whatsapp.svg" height="26" width="26">
                        </a></li>
                </ul>
            </div>
        </div>
