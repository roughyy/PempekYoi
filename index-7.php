                                    ...
                                    <div class="col-span-12 lg:col-span-5 xl:col-span-6">
                                        <div class="slider-content">
                                            <div class="relative mb-5 sub_title">
                                                ...
                                                <span class="bg-[#FFF6F0] text-base text-secondary block absolute left-[28px] top-1/2 -translate-y-1/2">A new way
                                            ...
                                            <span class="block font-recoleta hero_info"><span class="text-[20px] sm:text-[22px] text-secondary">Have a question?</span> <a href="tel:9985254784" class="text-[22px] sm:text-[32px] text-primary hover:underline">+9985 254 784</a></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-span-12 lg:col-span-8 mb-[30px]">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[30px] mb-[-30px]">
                            <div class="mb-[30px]">
                                ...
                                <div>
                                    <span class="block leading-none font-normal text-[14px] text-secondary mb-[10px] relative before:absolute before:left-0 before:top-1/2 -translate-y-1/2 before:bg-secondary before:content-[''] before:w-[3px] before:h-[3px] before:rounded-full pl-[10px]">James Alber on 22 December, 21</span>
                                    <h3><a href="blog-details.html" class="font-recoleta text-[22px] xl:text-[28px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all">Tip’s about Real Estate Recent Conditions from Agent.</a></h3>
                            ...
                            <div class="mb-[30px]">
                                ...
                                <div>
                                    <span class="block leading-none font-normal text-[14px] text-secondary mb-[10px] relative before:absolute before:left-0 before:top-1/2 -translate-y-1/2 before:bg-secondary before:content-[''] before:w-[3px] before:h-[3px] before:rounded-full pl-[10px]">Shohel Gyes on 21 December, 21</span>
                                    <h3><a href="blog-details.html" class="font-recoleta text-[22px] xl:text-[28px] leading-[1.285] text-primary block mb-[10px] hover:text-secondary transition-all">Importance of Build quality of modern Real Estate.</a></h3>
                                    <p class="font-light text-[#494949] text-[16px] leading-[1.75]">Properties are most budget friendly so you have are opportunity to find are the best the best...</p>
                                </div>
                            </div>
